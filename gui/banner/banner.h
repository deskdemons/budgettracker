...
public:
    ...
    Banner(std::string bannerText, sf::Vector2f position, sf::Vector2f dimension, int radius, sf::Font &font,
           int fontSize, sf::Color fontColor, sf::Color bgColor, int borderThickness, sf::Color borderColor,
           int paddingLeft,
           int paddingRight);//constructor //position, dimension, radius, font, size of txt, txtColor, bgColor, outLineThickness, outLineColor

...
Banner::Banner(std::string bannerText, sf::Vector2f position, sf::Vector2f dimension, int radius, sf::Font &font,
               int fontSize, sf::Color fontColor, sf::Color bgColor, int outLineThickness, sf::Color outLineColor,
               int paddingL,
               int paddingT) {//position, dimension, radius, font, size of txt, txtColor, bgColor, outLineThickness, outLineColor
    ...
    text.setCharacterSize(fontSize);
    text.setFillColor(fontColor);
    bannerBg = RoundedRectangle(position, dimension, radius, bgColor, outLineThickness,

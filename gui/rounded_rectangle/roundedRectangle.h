...
public:
    ...
    RoundedRectangle(sf::Vector2f position, sf::Vector2f dimension, int radius, sf::Color bgColor, int borderThickness,
                     sf::Color borderColor);//position, dimension, radius, fillColor, outLineThickness, outLineColor

...
public:
    ...
    void setContents(
            std::vector<std::vector<std::string> > contents);    //setter for contents of table. actual contents should be string
    ...
    void setHeaderPadding(
            sf::Vector2f headerPadding);    //padding for text inside header row. ex: sf::Vector2f(10,0); for left, top

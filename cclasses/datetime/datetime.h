...
public:
    ...
    bool setDateTime(int h, int m, int s, int mo, int d, int y); //set time in 24 hour format as hour, minute, second, month, day, year
    bool deserialize(std::string datetime);                      //pass string like "12th Jan 2021 - 12:17:23 PM" and it sets private variables accordingly. String should strictly should be in aforementioned format or it returns bool as false and doesn't set any value.

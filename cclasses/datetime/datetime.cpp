...
bool DateTime::operator==(DateTime obj)
{
    if (year == obj.year && month == obj.month && day == obj.day && hour == obj.hour && minute == obj.minute && second == obj.second)
    {
        return true;
    }
    else
...
std::string DateTime::getDateTime()
{
    ...
    return intToString(day) + suffixOfDay(day) + " " + monStr(month - 1) + " " + intToString(year) + " - " + intToString(hr) + ":" + intToString(minute) + ":" + intToString(second) + ampm(hour);
}
